...
import { Calendar, Plus, Bell, LogOut, User as UserIcon, Search, Filter, Clock, Globe, CheckCircle, XCircle, Pause, Play, Trash2, Edit, MoreVertical, Settings, CreditCard } from 'lucide-react'
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-white text-sm hidden md:block">{user.email?.split('@')[0]}</span>
                </button>
                ...
                <div className="flex-grow space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    <span className={`inline-flex items-center space-x-2 text-xs px-3 py-1 rounded-full border ${getStatusColor(monitor.status)}`}>
                      ...
                      {monitor.status === 'error' && <XCircle className="w-3 h-3" />}
                    ...
                    <div className="flex items-center space-x-1">
                      {monitor.notifications.includes('email') && (
                        <div className="w-6 h-6 rounded-full bg-purple-500/20 flex items-center justify-center" title="Email notifications">
                          <span className="text-xs text-purple-400">@</span>
                        </div>
                      )}
                      {monitor.notifications.includes('sms') && (
                        <div className="w-6 h-6 rounded-full bg-blue-500/20 flex items-center justify-center" title="SMS notifications">
                          <span className="text-xs text-blue-400">📱</span>
                        </div>
                      )}
                      {monitor.notifications.includes('whatsapp') && (
                        <div className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center" title="WhatsApp notifications">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-300">
                <li>• Set your preferred date ranges to get more relevant matches</li>
                <li>• Enable multiple notification channels to never miss an alert</li>
                <li>• Premium plans check every 1-3 minutes for the fastest results</li>
                <li>• Pause monitors when you&apos;ve secured your appointment to save credits</li>
              </ul>
            </div>
          </div>
        </div>
